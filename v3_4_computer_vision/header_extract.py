...
Selected billing codes are intentionally absent from the header model schema.
Runtime code selection is handled separately by the locked-candidate crop reader;
the header/notes model cannot emit billing-code arrays.
"""
