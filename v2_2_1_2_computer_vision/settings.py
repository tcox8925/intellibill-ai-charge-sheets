...
class Settings:
    ...
    mark_multi_promote_confidence: float
    mark_multi_strong_score: float
...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        pipeline_version=os.getenv(
            ...
            "locked-candidates-ai-verified-v2.2.1-distinct-multicircle",
        ).strip(),
        ...
        mark_resolver_version=os.getenv(
            ...
            "candidate_crop_resolver_v2_2_1_distinct_multicircle",
        ).strip(),
        ...
        mark_multi_promote_confidence=_float("CHARGESHEET_MARK_MULTI_PROMOTE_CONFIDENCE", 0.55),
        mark_multi_strong_score=_float("CHARGESHEET_MARK_MULTI_STRONG_SCORE", 0.58),
